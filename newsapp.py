...
# Importing the Data
df = pd.read_excel("C:\\Users\\dudei\\News_Classifier_org.xlsx")
...
with open("C:\\Users\\dudei\\News_Classifier\\clean.pkl", "rb") as f:
    clean = pickle.load(f)

with open("C:\\Users\\dudei\\News_Classifier\\vec.pkl", "rb") as f:
    vectorizer = pickle.load(f)

with open("C:\\Users\\dudei\\News_Classifier\\knn_Model_S.pkl", "rb") as f:
    knn = pickle.load(f)

with open("C:\\Users\\dudei\\News_Classifier\\pca.pkl", "rb") as f:
    pca = pickle.load(f)
